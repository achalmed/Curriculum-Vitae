...
tipo: doc
estado: activo
titulo: "Referencia de la plantilla YAAC y sus macros (sistema modular de CV)"
---
# Referencia de la plantilla YAAC — sistema modular de CV
...
- [README.md](README.md) - Índice de las guías (generado)
