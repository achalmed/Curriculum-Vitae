...
- El despacho es, desde 2026-09-15, un repo git propio y privado (sin remoto) de registros y perfil:
  cliente de los repos `marco_documental`, `sgdp`, `identidad_visual` y `openproject_despacho` de
  `~/Documents/`. Su `CLAUDE.md` manda allí; `despacho.yml` es el manifiesto y `./doctor.sh` la salud.
  Ya no hay repos anidados dentro (`meta/DIAGNOSTICO_DESPACHO_2026-09.md`, fases D0 a D8).
